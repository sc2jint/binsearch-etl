...
public class Task {
    //缓存
    Cache<Long, FileType3FeatureDTO> loadingCache;
    ...
    public void initLoadingCache(long cacheMaximum,Executor exception, RemovalListener<Long, FileType3FeatureDTO> removalListener){
